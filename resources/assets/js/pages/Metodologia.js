          ...
          <div className=" mt-5 row">
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              <ul>
                ...
                <li>
                Teste: Haverá teste em todas as fases do desenvolvimento, que serão feitos por todos da equipe, sendo primeiro pelos programadores (Samyla/Gilmara), pelos testadores da equipe (Julilma/Gildenilson) e por último pelo cliente que dará a palavra final. Entrada: Protótipo com os critérios para testes. Saída: Produto.
                </li>
              </ul>
            </div>
          </div>
